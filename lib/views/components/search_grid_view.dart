...
import 'package:instagram_clone/views/components/animations/data_not_fount_animation_view.dart';
...
import 'package:instagram_clone/views/components/posts/post_sliver_grid_view.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return posts.when(
      ...
      error: (error, stackTrace) {
        return const SliverToBoxAdapter(child: SmallErrorAnimationView());
      },
      loading: () {
        return const SliverToBoxAdapter(
          child: Center(
